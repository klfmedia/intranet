...
<div id="buddypress">
	...
	<div class="item-list-tabs activity-type-tabs" role="navigation">
		<ul>
			...
			<li class="selected" id="activity-all"><a href="<?php bp_activity_directory_permalink(); ?>" title="<?php esc_attr_e( 'The public activity activity for everyone on this site.', 'thrive' ); ?>"><?php printf( __( 'All Members <span>%s</span>', 'thrive' ), bp_get_total_member_count() ); ?></a></li>
			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<?php if ( bp_is_active( 'groups' ) ) : ?>
					...
					<?php if ( bp_get_total_group_count_for_user( bp_loggedin_user_id() ) ) : ?>
						...
						<li id="activity-groups"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/' . bp_get_groups_slug() . '/'; ?>" title="<?php esc_attr_e( 'The activity of groups I am a member of.', 'thrive' ); ?>"><?php printf( __( 'My Groups <span>%s</span>', 'thrive' ), bp_get_total_group_count_for_user( bp_loggedin_user_id() ) ); ?></a></li>
				...
				<?php if ( bp_activity_do_mentions() ) : ?>
					...
					<li id="activity-mentions"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/mentions/'; ?>" title="<?php esc_attr_e( 'Activity that I have been mentioned in.', 'thrive' ); ?>"><?php _e( 'Mentions', 'thrive' ); ?><?php if ( bp_get_total_mention_count_for_user( bp_loggedin_user_id() ) ) : ?> <strong><span><?php printf( _nx( '%s new', '%s new', bp_get_total_mention_count_for_user( bp_loggedin_user_id() ), 'Number of new activity mentions', 'thrive' ), bp_get_total_mention_count_for_user( bp_loggedin_user_id() ) ); ?></span></strong><?php endif; ?></a></li>
