...
<div id="buddypress">
	...
	<form action="" method="post" id="blogs-directory-form" class="dir-form">
		...
		<div class="item-list-tabs" role="navigation">
			<ul>
				<li class="selected" id="blogs-all"><a href="<?php bp_root_domain(); ?>/<?php bp_blogs_root_slug(); ?>"><?php printf( __( 'All Sites <span>%s</span>', 'thrive' ), bp_get_total_blog_count() ); ?></a></li>

				<?php if ( is_user_logged_in() && bp_get_total_blog_count_for_user( bp_loggedin_user_id() ) ) : ?>

					<li id="blogs-personal"><a href="<?php echo bp_loggedin_user_domain() . bp_get_blogs_slug(); ?>"><?php printf( __( 'My Sites <span>%s</span>', 'thrive' ), bp_get_total_blog_count_for_user( bp_loggedin_user_id() ) ); ?></a></li>
		...
		<div class="item-list-tabs" id="subnav" role="navigation">
			<ul>
				...
				<li id="blogs-order-select" class="last filter">
					...
					<label for="blogs-order-by"><?php _e( 'Order By:', 'thrive' ); ?></label>
					<select id="blogs-order-by">
						<option value="active"><?php _e( 'Last Active', 'thrive' ); ?></option>
						<option value="newest"><?php _e( 'Newest', 'thrive' ); ?></option>
