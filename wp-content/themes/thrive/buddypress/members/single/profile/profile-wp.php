...
<?php
	...
	<div class="bp-widget wp-profile">
		...
		<h4><?php bp_is_my_profile() ? _e( 'My Profile', 'thrive' ) : printf( __( "%s's Profile", 'thrive' ), bp_get_displayed_user_fullname() ); ?></h4>
		...
		<table class="wp-profile-fields">
			...
			<?php if ( $ud->display_name ) : ?>
				...
				<tr id="wp_displayname">
					<td class="label"><?php _e( 'Name', 'thrive' ); ?></td>
			...
			<?php if ( $ud->user_description ) : ?>
				...
				<tr id="wp_desc">
					<td class="label"><?php _e( 'About Me', 'thrive' ); ?></td>
			...
			<?php if ( $ud->user_url ) : ?>
				...
				<tr id="wp_website">
					<td class="label"><?php _e( 'Website', 'thrive' ); ?></td>
			...
			<?php if ( $ud->jabber ) : ?>
				...
				<tr id="wp_jabber">
					<td class="label"><?php _e( 'Jabber', 'thrive' ); ?></td>
			...
			<?php if ( $ud->aim ) : ?>
				...
				<tr id="wp_aim">
					<td class="label"><?php _e( 'AOL Messenger', 'thrive' ); ?></td>
			...
			<?php if ( $ud->yim ) : ?>
				...
				<tr id="wp_yim">
					<td class="label"><?php _e( 'Yahoo Messenger', 'thrive' ); ?></td>
