	...
	<div class="page " id="register-page">
		...
		<?php if ( 'registration-disabled' == bp_get_current_signup_step() ) : ?>
			...
			do_action( 'bp_before_registration_disabled' ); ?>
				...
				<p><?php _e( 'User registration is currently not allowed.', 'thrive' ); ?></p>
		...
		<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
			...
			<p><?php _e( 'Registering for this site is easy. Just fill in the fields below, and we\'ll get a new account set up for you in no time.', 'thrive' ); ?></p>
			...
			<div class="register-section col-md-6" id="basic-details-section">

				<?php /***** Basic Account Details ******/ ?>

				<h4><?php _e( 'Account Details', 'thrive' ); ?></h4>

				<div class="thrive-register-fields-xprofile">
					<label for="signup_username"><?php _e( 'Username', 'thrive' ); ?> <?php _e( '(required)', 'thrive' ); ?></label>
					<?php
					/**
					...
					<?php bp_form_field_attributes( 'username' ); ?>/>
					<?php	do_action( 'bp_signup_username_errors' ); ?>
				</div>

				<div class="thrive-register-fields-xprofile">
					<label for="signup_email"><?php _e( 'Email Address', 'thrive' ); ?> <?php _e( '(required)', 'thrive' ); ?></label>
				...
				<div class="thrive-register-fields-xprofile">
					<label for="signup_password">
							<?php _e( 'Choose a Password', 'thrive' ); ?> <?php _e( '(required)', 'thrive' ); ?>
					</label>
			...
			<div class="thrive-register-fields-xprofile">
				<label for="signup_password_confirm"><?php _e( 'Confirm Password', 'thrive' ); ?> <?php _e( '(required)', 'thrive' ); ?></label>
			...
			<?php if ( bp_is_active( 'xprofile' ) ) : ?>
				...
				<div class="register-section col-md-6" id="profile-details-section">

					<h4><?php _e( 'Profile Details', 'thrive' ); ?></h4>
					...
					<?php while ( bp_profile_fields() ) : bp_the_profile_field(); ?>
						...
						<div<?php bp_field_css_class( array('editfield', 'thrive-register-fields-xprofile') ); ?>>
							...
							if ( bp_current_user_can( 'bp_xprofile_change_field_visibility' ) ) : ?>
								<p class="field-visibility-settings-toggle" id="field-visibility-settings-toggle-<?php bp_the_profile_field_id() ?>">
									<?php printf( __( 'This field can be seen by: <span class="current-visibility-level">%s</span>', 'thrive' ), bp_get_the_profile_field_visibility_level_label() ) ?> <a href="#" class="visibility-toggle-link"><?php _ex( 'Change', 'Change profile field visibility level', 'thrive' ); ?></a>
								</p>
			...
			<?php if ( bp_get_blog_signup_allowed() ) : ?>
				...
				<div class="register-section" id="blog-details-section">
					...
					<h4><?php _e( 'Blog Details', 'thrive' ); ?></h4>

					<p><input type="checkbox" name="signup_with_blog" id="signup_with_blog" value="1"<?php if ( (int) bp_get_signup_with_blog_value() ) : ?> checked="checked"<?php endif; ?> /> <?php _e( 'Yes, I\'d like to create a new site', 'thrive' ); ?></p>

					<div id="blog-details"<?php if ( (int) bp_get_signup_with_blog_value() ) : ?>class="show"<?php endif; ?>>

						<label for="signup_blog_url"><?php _e( 'Blog URL', 'thrive' ); ?> <?php _e( '(required)', 'thrive' ); ?></label>
						<?php
						...
						<label for="signup_blog_title"><?php _e( 'Site Title', 'thrive' ); ?> <?php _e( '(required)', 'thrive' ); ?></label>
						<?php
						...
						<span class="label"><?php _e( 'I would like my site to appear in search engines, and in public listings around this network.', 'thrive' ); ?></span>
						<?php
						...
						<label><input type="radio" name="signup_blog_privacy" id="signup_blog_privacy_public" value="public"<?php if ( 'public' == bp_get_signup_blog_privacy_value() || !bp_get_signup_blog_privacy_value() ) : ?> checked="checked"<?php endif; ?> /> <?php _e( 'Yes', 'thrive' ); ?></label>
						<label><input type="radio" name="signup_blog_privacy" id="signup_blog_privacy_private" value="private"<?php if ( 'private' == bp_get_signup_blog_privacy_value() ) : ?> checked="checked"<?php endif; ?> /> <?php _e( 'No', 'thrive' ); ?></label>
			...
			<div class="submit">
				<input type="submit" name="signup_submit" id="signup_submit" value="<?php esc_attr_e( 'Complete Sign Up', 'thrive' ); ?>" />
			</div>
		...
		<?php if ( 'completed-confirmation' == bp_get_current_signup_step() ) : ?>
			...
			<?php if ( bp_registration_needs_activation() ) : ?>
				<p><?php _e( 'You have successfully created your account! To begin using this site you will need to activate your account via the email we have just sent to your address.', 'thrive' ); ?></p>
			<?php else : ?>
				<p><?php _e( 'You have successfully created your account! Please log in using the username and password you have just created.', 'thrive' ); ?></p>
			<?php endif; ?>
