...
<script id="tmpl-bp-avatar-delete" type="text/html">
	<# if ( 'user' === data.object ) { #>
		...
		<p><a class="button edit" id="bp-delete-avatar" href="#" title="<?php esc_attr_e( 'Delete Profile Photo', 'thrive' ); ?>"><?php esc_html_e( 'Delete My Profile Photo', 'thrive' ); ?></a></p>
	<# } else if ( 'group' === data.object ) { #>
		...
		<p><a class="button edit" id="bp-delete-avatar" href="#" title="<?php esc_attr_e( 'Delete Group Profile Photo', 'thrive' ); ?>"><?php esc_html_e( 'Delete Group Profile Photo', 'thrive' ); ?></a></p>
	<# } else { #>
