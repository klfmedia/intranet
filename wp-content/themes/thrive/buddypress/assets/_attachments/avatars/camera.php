...
<script id="tmpl-bp-avatar-webcam" type="text/html">
	<# if ( ! data.user_media ) { #>
		<div id="bp-webcam-message">
			<p class="warning"><?php esc_html_e( 'Your browser does not support this feature.', 'thrive' );?></p>
		</div>
	<# } else { #>
		...
		<div class="avatar-crop-management">
			...
			<div id="avatar-crop-actions">
				<a class="button avatar-webcam-capture" href="#"><?php esc_html_e( 'Capture', 'thrive' );?></a>
				<a class="button avatar-webcam-save" href="#"><?php esc_html_e( 'Save', 'thrive' );?></a>
			</div>
		</div>
	<# } #>
</script>
