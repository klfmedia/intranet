...
if ( bp_get_new_group_invite_friend_list() ) : ?>
	...
	<form action="<?php bp_group_send_invite_form_action(); ?>" method="post" id="send-invite-form" class="standard-form">
		...
		<div class="submit">
			<input type="submit" name="submit" id="submit" value="<?php esc_attr_e( 'Send Invites', 'thrive' ); ?>" />
		</div>
...
elseif ( 0 == bp_get_total_friend_count( bp_loggedin_user_id() ) ) : ?>
	...
	<div id="message" class="info">
		<p class="notice"><?php _e( 'Group invitations can only be extended to friends.', 'thrive' ); ?></p>
		<p class="message-body"><?php _e( "Once you've made some friendships, you'll be able to invite those members to this group.", 'thrive' ); ?></p>
	</div>
...
/* The user does have friends, but none are eligible to be invited to this group. */
	...
	<div id="message" class="info">
		<p class="notice"><?php _e( 'All of your friends already belong to this group.', 'thrive' ); ?></p>
	</div>
