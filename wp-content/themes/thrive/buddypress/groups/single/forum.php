	...
	<div class="item-list-tabs no-ajax" id="subnav" role="navigation">
		<ul>
			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<li>
					<a href="#post-new" class="show-hide-new"><?php _e( 'New Topic', 'thrive' ); ?></a>
				</li>
		...
		<form action="" method="post" id="forum-topic-form" class="standard-form">
			<div id="new-topic-post">
				...
				<?php if ( bp_groups_auto_join() && !bp_group_is_member() ) : ?>
					<p><?php _e( 'You will auto join this group when you start a new topic.', 'thrive' ); ?></p>
				<?php endif; ?>

				<p id="post-new"></p>
				<h4><?php _e( 'Post a New Topic:', 'thrive' ); ?></h4>
