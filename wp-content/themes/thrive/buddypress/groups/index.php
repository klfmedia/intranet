...
<div id="buddypress">
	...
	<form action="" method="post" id="groups-directory-form" class="dir-form">
		...
		<div class="item-list-tabs" role="navigation">
			<ul>
				<li class="selected" id="groups-all"><a href="<?php bp_groups_directory_permalink(); ?>"><?php printf( __( 'All Groups <span>%s</span>', 'thrive' ), bp_get_total_group_count() ); ?></a></li>

				<?php if ( is_user_logged_in() && bp_get_total_group_count_for_user( bp_loggedin_user_id() ) ) : ?>
					<li id="groups-personal"><a href="<?php echo bp_loggedin_user_domain() . bp_get_groups_slug() . '/my-groups/'; ?>"><?php printf( __( 'My Groups <span>%s</span>', 'thrive' ), bp_get_total_group_count_for_user( bp_loggedin_user_id() ) ); ?></a></li>
				<?php endif; ?>
		...
		<div class="item-list-tabs" id="subnav" role="navigation">
			<ul>
				...
				<li id="groups-order-select" class="last filter">
					...
					<label for="groups-order-by"><?php _e( 'Order By:', 'thrive' ); ?></label>

					<select id="groups-order-by">
						<option value="active"><?php _e( 'Last Active', 'thrive' ); ?></option>
						<option value="popular"><?php _e( 'Most Members', 'thrive' ); ?></option>
						<option value="newest"><?php _e( 'Newly Created', 'thrive' ); ?></option>
